(() => {
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full KYC Approval record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        ...
        <p>${escapeHtml(finding.evidenceStatus)} · 12 September KYC Approval Chrome campaign. Private webapp <code>.github/evidence/uat/kyc-approval/2026-09-12/</code> records are the source of this sanitized consolidation. <a href="#coverage" id="dialog-coverage">View scenario coverage and provenance</a>.</p>
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · KYC Approval Chrome evidence run</small></div>
  ...
  function exportCsv() {
    ...
    link.download = 'kyc-approval-uat-20260912.csv';
    link.click();
